...
public class FreeCrmTest {
	...
	public void setUp() throws Exception {
		System.setProperty("webdriver.chrome.driver", "//Users//myair//Documents//MehdiWork//4d-tests//src//main//resources//drivers//chromedriver");
	...
	public void freeCrmTitleTest() throws InterruptedException, IOException {
		...
		if (title.contains("Free CRM software in the cloud")) {
